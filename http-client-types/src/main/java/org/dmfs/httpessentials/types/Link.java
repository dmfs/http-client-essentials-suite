...
public interface Link extends Parametrized
{
    ...
    /**
     * Returns the context of the link (the value of the anchor parameter, if present). If the anchor is a relative URI,
     * it will be resolved relatively to the provided default context {@link URI}.
     *
     * @param context
     ...
     * <p/>
     * Note: According to <a href="https://tools.ietf.org/html/rfc5988#section-5">RFC 5988, Section 5</a> relation types
     * can be Strings or URIs. This implementation returns all relation types as strings, since it's mostly used as an
     * opaque token. The downside of this is that extended relation types may have different string representations due
     * to different encodings, and may be difficult to match.
     *
     * @return
     */
