 ...
 * <p>
 * Characters in the input string that are not allowed for token according to <a href="https://tools.ietf.org/html/rfc7230#section-3.2.6">RFC7230</a>
...
public final class SafeToken extends AbstractStringType implements Token
{
     ...
     *
     * @param value
     *         the token content, must not be null or empty. Characters not allowed for token will be replaced with
     *         underscore.
     */
