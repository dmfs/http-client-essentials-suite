 ...
 * @author Marten Gajda
 */
public class AuthDigestCredentialsTest
{
    @Test
    public void testParameters() throws Exception
    {
        ...
        Credentials credentials = new AuthDigestCredentials(HttpMethod.GET, URI.create("/dir/index.html"), mockChallenge, mockUserCredentials, "0a4f113b");
        for (Pair<Token, CharSequence> param : credentials.parameters())
        {
            System.out.println(String.format("%s: %s", param.left(), param.right().toString()));
        }
        System.out.println(new SingleCredentials(credentials).value().toString());
    }
    ...
    public void testParameters2() throws Exception
    {
        ...
        Credentials credentials = new AuthDigestCredentials(HttpMethod.GET, URI.create("/dir/index.html"), mockChallenge, mockUserCredentials,
