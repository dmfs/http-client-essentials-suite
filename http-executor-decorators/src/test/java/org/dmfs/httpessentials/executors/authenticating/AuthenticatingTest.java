...
import org.dmfs.httpessentials.executors.authenticating.strategies.Composite;
import org.dmfs.httpessentials.executors.authenticating.strategies.UserCredentialsAuthStrategy;
...
public class AuthenticatingTest
{
    ...
    {
        HttpRequestExecutor executor = new Authenticating(new HttpUrlConnectionExecutor(), new Composite(new UserCredentialsAuthStrategy(
