...
/**
 * A standard retry policy that will retry all idempotent requests that failed with an IOException, except
 * SSLExceptions, for the maximum number of times it is configured to.
 *
