...
/**
 * The {@link Credentials} of the Basic auth scheme.
 *
 * @author Marten Gajda
 */
public final class BasicCredentials implements Credentials
{
    ...
    public BasicCredentials(UserCredentials credentials)
    {
        this(credentials, "UTF-8");
    }


    public BasicCredentials(UserCredentials credentials, String encoding)
    {
