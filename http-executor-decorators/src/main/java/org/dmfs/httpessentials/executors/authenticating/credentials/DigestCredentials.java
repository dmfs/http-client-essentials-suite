...
/**
 * The {@link Credentials} of a DIGEST authentication scheme as per <a href="https://tools.ietf.org/html/rfc2069">RFC 2069</a>
 *
 * @author Marten Gajda
 */
public final class DigestCredentials implements Credentials
{
    ...
    public DigestCredentials(HttpMethod method, URI requestUri, Challenge digestChallenge, UserCredentials userCredentials)
    {
        mMethod = method;
