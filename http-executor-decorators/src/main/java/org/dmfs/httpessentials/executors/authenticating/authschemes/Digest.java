...
import org.dmfs.httpessentials.executors.authenticating.authstates.digest.DigestAuthState;
...
public final class Digest implements AuthScheme<UserCredentials>
{
    ...
    {
        return new DigestAuthState(credentialsStore, method, uri, naFallback, failFallback);
    }
}
