...
/**
 * A simple {@link HttpRequestExecutor} to test response handling. This class emulates a server that responds to all
 * URLs and with the same response each time.
 *
