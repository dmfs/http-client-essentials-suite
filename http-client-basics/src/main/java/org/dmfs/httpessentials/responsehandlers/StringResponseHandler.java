...
/**
 * A simple {@link HttpResponseHandler} that returns the response body as a {@link String} using the charset given in
 * the content-type if there is any or falling back to a default charset otherwise.
 *
...
public final class StringResponseHandler implements HttpResponseHandler<String>
{
    ...
    /**
     * A {@link StringResponseHandler} that falls back to {@value #UTF8_CHARSET} if there is no charset given in the
     * response.
     */
    ...
    /**
     * A {@link StringResponseHandler} that falls back to the given charset if there is no charset given in the
     * response.
     */
