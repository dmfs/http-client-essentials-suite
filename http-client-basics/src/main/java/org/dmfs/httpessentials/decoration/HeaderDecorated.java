...
/**
 * {@link HttpRequest} decorator that changes only the {@link Headers} using the given {@link Decoration}.
 *
...
public final class HeaderDecorated<T> implements HttpRequest<T>
{
    ...
    {
        return mHeadersDecoration.decorated(mOriginalRequest.headers());
    }
