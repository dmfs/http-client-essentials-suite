...
/**
 * Represents a header type. That is, it binds a header name to a value type. In contrast to {@link SingletonHeaderType}
 * this is for headers that are defined to have a list value.
 * <p/>
