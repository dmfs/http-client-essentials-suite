...
/**
 * Interface of an HTTP status. Instances must be immutable.
 * <p>
 * By convention, all implementations MUST return the status code when {@link #hashCode()} is called and equality is solely based on the hash code.
 *
 * @author Marten Gajda
 */
public interface HttpStatus
{
     ...
     */
    HttpStatus CONTINUE = new StructuredHttpStatus(100, "Continue");

    /**
     * HTTP status: <a href="http://tools.ietf.org/html/rfc7231#section-6.2.2">101 Switching Protocols</a>
     */
    HttpStatus SWITCHING_PROTOCOLS = new StructuredHttpStatus(101, "Switching Protocols");
     ...
     */
    HttpStatus PROCESSING = new StructuredHttpStatus(102, "Processing");
     ...
     */
    HttpStatus URI_TOO_LONG = new StructuredHttpStatus(414, "URI Too Long");
    ...
    /**
     * Returns the reason phrase of this status code or an empty {@link String} if the reason phrase is unknown.
     * <p>
     * Note, the reason phrase doesn't contain the status code.
     */
    String reason();
