...
/**
 * An {@link Exception} that's thrown when the server returns a (unhandled) redirect. <p> There are two subclasses for
 * specific error conditions: {@link TooManyRedirectsException} and {@link RedirectionLoopException}. </p>
 *
